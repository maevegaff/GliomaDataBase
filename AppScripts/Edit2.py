...
if uploaded_file1 and uploaded_file2:
    ...
    # Encode 'Gene_High_Low' as 0 (Low) and 1 (High)
    ...
    # Generate survival curves for both High and Low Expression
    cph.plot_survival_function(ax=ax)

    # Customize plot
    ax.set_title('Survival Function for High vs. Low Gene Expression')
    ax.set_xlabel('Time (days)')
    ax.set_ylabel('Survival Probability')
    ax.legend(['Low Expression', 'High Expression'])
